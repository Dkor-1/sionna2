...
# 회수 원본(수집 45편 + 판정 41건). 저장소 안 사본이 정본이고, 스크래치패드는 원본 위치다.
REC = "/workspace/sionna/prior_work/outputs/md_classification_dl_survey_recovered.json"
REC_ORIGIN = ("/tmp/claude-0/-workspace/e9e31991-b542-4f3a-b8e2-570320d555ba/"
    ...
    doc = {
        "_meta": {
            ...
            "recovery": {
                ...
                "recovered_file": REC,
                "recovered_file_origin": REC_ORIGIN,
