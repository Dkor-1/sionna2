...
| ⑦ | **새(bird) 클래스** | ⛔「Molchanov 2014 이후 거의 전편」은 내렸다(2026-09-06 — §3-1 표가 뒷받침하지 않는다) → **본표(§3-1) 29편 중 12편**이 새(바이오닉버드 포함) 클래스를 둔다: Molchanov 2014 · Björklund 2018 · Rahman 2020 · DIAT-μSAT 2022 · Dai 2023 · White 2023 · Larrat 2025 · Xue(DC-Former) 2025 · Zhang & Song 2026 · AirGuard 2026 · Networked ISAC 2026 · Mustafa 2026. 나머지 17편은 새 없이 드론끼리·사람·차량과 가른다(대조: outputs/md_classification_dl_survey.json :: table_classification_papers) | 우리 3클래스는 전부 회전익이다. 문헌이 10년째 푸는 «드론 vs 새»가 우리 판엔 없다 — 넣기 전엔 **난이도 비교 자체가 성립하지 않는다** |
...
- 템플릿을 +5/+10 Hz 밀면 74.7/65.2 %(우리) · 89.3/78.9 %(Sionna) — 빗살이 **주파수에 얼마나
  날카롭게 걸려 있나**의 측정이다.
- Sionna 팔은 **0° 앙각 72.9 % · −90° 89.6 %** 로 떨어진다(−15°~−75° 다섯 앙각은 100 %)
  ⛔전 판의 «0° 에서만 … 다른 앙각은 100 %» 는 원장과 어긋났다 — `classify_airframe.json`
  의 sionna 열은 −90° 가 **0.8958** 이다(2026-09-04 정정). — 엔진 차이가 특정 기하에
