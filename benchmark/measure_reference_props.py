...
⛔⛔ **2026-08-16 정정 — 옛 문장 두 개를 철회한다.**
   ...
   ② 는 ① 위에 서 있던 판단이라 같이 무너졌다. 실물 DJI 평면형과 대보니 **Solo 가 참조
     넷 중 유일한 이상치**다(⛔2026-08-16 적대 검증에서 정정 — 아래 참조) — 정규화 시위 `c/c_max @0.70R` 이 Mini2 공식CAD 0.866 ·
...
PROPS = {
    ...
    "3dr_solo": dict(
        ...
        caveat="소비자용 쿼드 프롭(10 in). 공칭 피치 4.5 in 은 가정. "
               ...
               "⛔정정(2026-08-16 적대 검증): «참조 넷 중 유일한 이상치» 가 아니라 참조 CAD 가 2:1 로 갈린다 — 1345 0.4896 · Solo 0.5754(뿌리 편중형) ↔ Yuneec 0.8669 · DJI Mini2 0.8638(늦은 정점형). 1345 가 Solo 보다 더 극단이고 감사 표에 그 행이 빠져 있었다. DJI 로 앵커를 옮기는 결론은 그대로 선다"
