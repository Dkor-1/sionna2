...
| `verify_server.py` (2026-09 보관: `/workspace/archive/2026-09/sionna/benchmark/`) | **RT 검증**: 환경진단 → RT CIR 추출 → RT↔Analytic 교차검증 → RT 최소셀 |
...
```bash
cd sionna2/benchmark
CUDA_VISIBLE_DEVICES=2 /workspace/.venvs/py312/bin/python /workspace/archive/2026-09/sionna/benchmark/verify_server.py  # archived 2026-09    # → outputs/figures/bench_rt_cell.png
```
