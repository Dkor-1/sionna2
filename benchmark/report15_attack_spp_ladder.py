# -*- coding: utf-8 -*-
"""
report15_attack_spp_ladder.py — ⭐ 적대검증 Q1 전용 실측
================================================================================
...
⛔ 기존 산출물 덮어쓰기 금지 → 출력은 outputs/report15_attack_spp_ladder.json (신규).
...
os.environ.setdefault(
    ...
    "a78e7d06-306f-4e2d-b124-5fe972bc4462/scratchpad/r15attack")

import report15_sweep_matrice4e as SW                                  # noqa: E402

OUT_JSON = os.path.join(ROOT, "outputs", "report15_attack_spp_ladder.json")
...
N_PHASE = 64
SPP_LADDER = (256_000_000, 1_024_000_000, 4_096_000_000)   # 16× 폭 (기존 사다리와 동일)
SPP_MAIN = 2_048_000_000          # 본 격자가 쓴 값
SEEDS_A = (1, 2, 3, 4, 5)         # A: 본 격자와 같은 시드 집합
SEEDS_B = tuple(range(1, 17))     # B: 시드 16개
...
def main():
    ...
    J = dict(meta=dict(
        script="benchmark/report15_attack_spp_ladder.py",
        role=("적대검증 Q1 — (a) 통계의 spp 의존·시드 표본수 의존을 직접 잰다"),
