...
RETRACTED: list = [
    #: ⭐2026-09-08 철회 — 「우리가 만든 씬에서만 무너진다」
    #:   원장 outputs/outdoor_dip_origin_0908.json summary.RETRACTED_ours_only = True.
    #:   레벨 문턱을 안 쓰고 «장면이 얹은 몫이 달라진 자세» 를 세면 거리 협곡에서도 난다 —
    #:   30° 96 자세(1.17 %) · 60° 128 자세(1.56 %). 우리 씬은 74(0.90 %) · 84(1.03 %) 다.
    #:   갈리는 것은 «있다/없다» 가 아니라 방향이다(우리 −53.30 dB · 협곡 +6.86 dB).
    #:   ⚠2026-09-09 검증에서 이 표에 없어서 관문이 이 건을 못 보고 있었다.
    (r"기본 씬에서는\s*\*{0,2}무너지는 자세가 없다|우리 씬에서는 나고 기본 씬에서는 안 난다"
     r"|기본 씬에서는 안 난다|우리 씬에서만 (?:난다|무너진다)",
     r".",                       # 좁힐 낱말이 따로 없다 — 문장 자체가 그 주장이다
     "0908 실외 — 「우리 씬에서만 무너진다」는 철회됐다. 문턱 없는 잣대로 세면 거리 협곡이 "
     "오히려 잦다(30° 1.17 % · 60° 1.56 % 대 우리 0.90 % · 1.03 %). 갈리는 것은 방향이다",
     ("outputs/outdoor_dip_origin_0908.json", "outputs/scene_compare_0908.json",
      "outputs/builtin_scene_diagnosis_0908.json",
      "docs/COMPLETED_INTERPRETATIONS_REVIEW_0908.md",
      "work/sweep_0904/RESUME_0908.md", "work/sweep_0904/RESUME_0909.md")),
