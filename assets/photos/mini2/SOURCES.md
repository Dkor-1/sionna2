...
| 양 | GLB 실측 | DJI 공표 | 오차 |
|---|---|---|---|
| 접힘 바깥치수 | **137.7 × 83.1 × 56.1 mm** | 138 × 81 × 58 mm | +0.2 % / +2.6 % / −3.3 % |
| 펼침 높이 | **56.4 mm** | 56 mm | +0.6 % |
| **모터 대각거리** | **213.9 mm** | **213 mm** | **+0.4 %** |
| **프로펠러 지름** | **119.1 mm** (뒤) / 118.1 mm (앞) | 미공표 | — (4.7 in = 119.4 mm 와 0.3 % 차) |

**모터 대각 213.9 vs 공표 213 mm 가 0.4 % 안에서 맞는 것**이 핵심 검증이다.
