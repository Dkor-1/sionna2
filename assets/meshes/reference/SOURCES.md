...
| `1345_prop_cw.stl` | **Holybro 1345 프로펠러** (13×4.5 — 13인치 지름·4.5피치, 실측 스팬 346 mm) | [PX4/PX4-gazebo-models](https://github.com/PX4/PX4-gazebo-models) `models/x500_base` | BSD-3-Clause |
