...
| **Li & Ling** ⚠등급 [N](PDF 디스크 부재) | IEEE AWPL, 2017 (~99 cites) | **3–6 GHz** (VNA, 구 보정) | Phantom 2 −27.5 · 3DR Solo −24.2 · Inspire 1 −13.7 dBsm(peak) | ⛔«우리 Mavic4Pro 방위평균@3.5GHz 가 Solo~Inspire 사이 = aspect-peak 범위 내» 는 내렸다(2026-09-04) — 우리 값은 방위평균, 문헌은 aspect-peak 라 지표가 다르다. 크기로 짝을 맞춘 현행 판정은 **«범위 안» 이 아니라 크기 짝 실측 대비 +8.0~+15.8 dB 과밝음**이다(docs/PRIOR_WORK_COMPARISON.md 「크기 짝 aspect-peak」 행·K15, 최정합 짝 phantom4 350 mm ↔ Phantom 2 350 mm = +15.79 dB). Aspect spread ~14 dB | https://ieeexplore.ieee.org/ (AWPL 2017) |
...
| **Semkin et al.** | IEEE Access vol.8, 2020 (DOI 10.1109/ACCESS.2020.2979339) | 26–40 GHz (무반향, 준모노) | Mavic Pro −16.8~−15.0 · Phantom4Pro −16.4~−12.3 · **M100(카본, 650 mm) −10.5~−6.6** dBsm | ⛔«카본이 플라스틱보다 mean +7 dB — 우리 재질차 방향 일치» 는 내렸다(2026-09-04). M100 은 650 mm 카본, Mavic Pro·Phantom4Pro 는 335~350 mm 플라스틱이라 크기 차만으로 10log10((650/335)²) = +5.7 dB 가 나온다 — 재질 단독 효과로 읽을 수 없고, 우리 재질차의 뒷받침으로 쓰지 않는다(docs/PRIOR_WORK_COMPARISON.md 「+7 dB 수치는 인용 금지」·K18). 가져오는 것은 규약(재질·로터상태·편파 명기)뿐이다. STATIC(로터정지) | https://ieeexplore.ieee.org/document/9032332/ |
