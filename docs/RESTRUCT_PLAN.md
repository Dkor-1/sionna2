...
| 위험도 | 위치 | 내용 → 조치 |
|---|---|---|
| 상 | `/workspace/team_meeting/teammeeting_0818/ROADMAP.md` :14,106,109,176,192 | reports/08_1~08_5·08_2_engines·08_3_pattern·08_5 — 다음 덱 작업이 옛 주소로 진행될 위험 최상 → 06_K 로 갱신 |
