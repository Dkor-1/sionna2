...
| 편 | 명령 | 출력 | 소요 |
|---|---|---|---|
| [00](../reports/_parts/00_map.ipynb) map | `PYTHONPATH=src python src/make_reports_index.py`<br>`PYTHONPATH=src python src/build_part00_map.py`<br>`PYTHONPATH=src python benchmark/check_report_links.py` | `outputs/reports_index.json` | 약 5초 (GPU 0장) |
...
| [05](../reports/_parts/05_size-sweep.ipynb) size-sweep | `PYTHONPATH=src python src/figs_report00.py`<br>`PYTHONPATH=src python src/build_part01_stock_engine.py` | `outputs/report00_evidence.json`<br>`outputs/facet_mechanism.json` | 약 1분 (GPU 0장 — JSON 읽기와 그림 그리기다) |
| [06](../reports/_parts/06_decision-table.ipynb) decision-table | `PYTHONPATH=src python benchmark/build_report00_decision_map.py`<br>`PYTHONPATH=src python src/figs_report00.py`<br>`PYTHONPATH=src python src/build_part01_stock_engine.py` | `outputs/report00_decision_map.json`<br>`outputs/report00_po_case.json`<br>`outputs/report00_evidence.json` | 약 1분 (GPU 0장) |
| [07](../reports/_parts/07_why-po.ipynb) why-po | `PYTHONPATH=src python benchmark/build_report00_po_case.py`<br>`PYTHONPATH=src python src/build_part01_stock_engine.py` | `outputs/report00_po_case.json`<br>`outputs/prior_work_survey.json` | 약 1분 (GPU 0장 — JSON 읽기다) |
...
| 편 | 명령 | 출력 | 소요 |
|---|---|---|---|
| [15](../reports/_parts/15_mesh-build.ipynb) mesh-build | `PYTHONPATH=src python src/make_report02_target.py --derive-only`<br>`PYTHONPATH=src python src/viz_mesh_gallery.py`<br>`PYTHONPATH=src python src/build_part03_target_mesh.py` | `outputs/report02_derived.json`<br>`outputs/meshfix_applied.json` | 약 2분 (GPU 0장 — 메쉬 조립과 렌더다) |
| [16](../reports/_parts/16_mesh-vs-real.ipynb) mesh-vs-real | `PYTHONPATH=src python src/make_report02_target.py --derive-only`<br>`PYTHONPATH=src python src/viz_mesh_photo.py`<br>`PYTHONPATH=src python src/build_part03_target_mesh.py` | `outputs/report02_derived.json`<br>`outputs/phantom4_scan_compare.json`<br>`outputs/real_cad_compare.json`<br>`outputs/community_compare.json` | 약 3분 (GPU 0장 — 사진 정합과 표 조립이다) |
| [17](../reports/_parts/17_materials.ipynb) materials | `PYTHONPATH=src python src/make_report02_target.py --derive-only`<br>`PYTHONPATH=src python src/viz_mesh_material.py`<br>`PYTHONPATH=src python src/build_part03_target_mesh.py` | `outputs/report02_derived.json` | 약 2분 (GPU 0장) |
...
| 편 | 명령 | 출력 | 소요 |
|---|---|---|---|
| [34](../reports/_parts/34_md-paths-doppler.ipynb) md-paths-doppler | `PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15_probe.py` | `outputs/report15_probe.json` | 약 7 분 (GPU 1장) |
| [35](../reports/_parts/35_md-slowtime.ipynb) md-slowtime | `PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15b_microdoppler_recompute.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15b_stamp_provenance.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/build_report15b_figs.py` | `outputs/report15b_microdoppler.json`<br>`outputs/report15b_series.npz` | 약 25 분 (GPU 1장 — 광선 추적이 6칸 × 4팔) |
| [36](../reports/_parts/36_md-two-engines.ipynb) md-two-engines | `PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15_po_control.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15_verdict_geomref.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15_verdict.py` | `outputs/report15_po_control.json`<br>`outputs/report15_verdict_geomref.json`<br>`outputs/report15_verdict.json` | 약 30 분 (GPU 1장) |
| [37](../reports/_parts/37_md-rpm.ipynb) md-rpm | `PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15b_microdoppler_recompute.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15b_stamp_provenance.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/build_report15b_figs.py` | `outputs/report15b_microdoppler.json`<br>`outputs/report15b_series.npz` | 약 25 분 (GPU 1장 — 광선 추적이 6칸 × 4팔) |
| [38](../reports/_parts/38_md-occlusion.ipynb) md-occlusion | `PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15b_microdoppler_recompute.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15b_stamp_provenance.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/build_report15b_figs.py` | `outputs/report15b_microdoppler.json`<br>`outputs/report15b_series.npz` | 약 25 분 (GPU 1장 — 광선 추적이 6칸 × 4팔) |
| [39](../reports/_parts/39_md-blade-vs-body.ipynb) md-blade-vs-body | `PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15b_microdoppler_recompute.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15b_stamp_provenance.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/build_report15b_figs.py` | `outputs/report15b_microdoppler.json`<br>`outputs/report15b_series.npz` | 약 25 분 (GPU 1장 — 광선 추적이 6칸 × 4팔) |
| [40](../reports/_parts/40_md-attitude.ipynb) md-attitude | `PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15b_microdoppler_recompute.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15b_stamp_provenance.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/build_report15b_figs.py` | `outputs/report15b_microdoppler.json`<br>`outputs/report15b_series.npz` | 약 25 분 (GPU 1장 — 광선 추적이 6칸 × 4팔) |
| [41](../reports/_parts/41_md-calibration.ipynb) md-calibration | `PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15_null_control_v2.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15_verdict_geomref.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15_verdict.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15_attack_stats.py` | `outputs/report15_null_control.json`<br>`outputs/report15_verdict_geomref.json`<br>`outputs/report15_verdict.json`<br>`outputs/report15_attack_stats.json` | 약 35 분 (GPU 1장 — 널 팔 13 개 [^14]) |
| [42](../reports/_parts/42_md-ray-budget.ipynb) md-ray-budget | `PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15_attack_spp_ladder.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/report15_attack_stats.py` | `outputs/report15_attack_spp_ladder.json`<br>`outputs/report15_attack_stats.json` | 약 36 분 (GPU 1장 — 사다리 전량 재추적) |
| [43](../reports/_parts/43_md-prf.ipynb) md-prf | `PYTHONPATH=src /workspace/.venvs/py312/bin/python src/experiment_md_range.py` | `outputs/md_range_sweep.json` | 약 12 분 (GPU 1장) |

## 부 8 — 조명원

| 편 | 명령 | 출력 | 소요 |
|---|---|---|---|
| [44](../reports/_parts/44_illuminators.ipynb) illuminators | `cd /workspace/sionna`<br>`/workspace/.venvs/py312/bin/python src/viz_report2.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part08_illuminators.py` | `outputs/report2_waveform_rcs.json`<br>`outputs/report03_illuminators.json` | ① 3412 s [^13] (대부분 같은 스크립트의 RCS 스윕) · ② CPU 20초 안쪽 |
| [45](../reports/_parts/45_5g-double-cost.ipynb) 5g-double-cost | `cd /workspace/sionna`<br>`/workspace/.venvs/py312/bin/python src/viz_report2.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part08_illuminators.py` | `outputs/report2_waveform_rcs.json`<br>`outputs/report03_illuminators.json` | CPU 20초 안쪽 (JSON 을 읽어 노트북을 조립한다) |
| [46](../reports/_parts/46_cost-ledger.ipynb) cost-ledger | `cd /workspace/sionna`<br>`/workspace/.venvs/py312/bin/python src/viz_report2.py`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/verify_ambiguity.py`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/report4_fixups.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part08_illuminators.py` | `outputs/report2_waveform_rcs.json`<br>`outputs/report4_fixups.json`<br>`outputs/report5_results.json`<br>`outputs/report03_illuminators.json` | ③ 556 s [^16] · ④ CPU 20초 안쪽 |
| [47](../reports/_parts/47_range-convention.ipynb) range-convention | `PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/verify_ambiguity.py`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/report4_fixups.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part08_illuminators.py` | `outputs/verify_ambiguity.json`<br>`outputs/report4_fixups.json` | ② GPU 1장 수 분 · ③ 556 s [^11] |
| [48](../reports/_parts/48_waveform-check.ipynb) waveform-check | `cd /workspace/sionna`<br>`/workspace/.venvs/py312/bin/python src/viz_report2.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part08_illuminators.py` | `outputs/report2_waveform_rcs.json` | ① 3412 s [^12] · ② CPU 20초 안쪽 |
| [49](../reports/_parts/49_ambiguity.ipynb) ambiguity | `PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/verify_ambiguity.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part08_illuminators.py` | `outputs/verify_ambiguity.json`<br>`outputs/report03_illuminators.json` | ② GPU 1장 수 분 · ④ CPU 20초 안쪽 |
| [50](../reports/_parts/50_doppler-fold.ipynb) doppler-fold | `PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/verify_ambiguity.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part08_illuminators.py` | `outputs/verify_ambiguity.json` | ② GPU 1장 수 분 · ④ CPU 20초 안쪽 |

## 부 9 — 검출기

| 편 | 명령 | 출력 | 소요 |
|---|---|---|---|
| [51](../reports/_parts/51_chain.ipynb) chain | `cd /workspace/sionna`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/verify_eca.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/viz_report04_detector.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part09_detector.py` | `outputs/verify_eca.json` | ECA 검증 · 그림은 각각 수 분 (GPU 1장) |
| [52](../reports/_parts/52_eca.ipynb) eca | `cd /workspace/sionna`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/verify_eca.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/viz_report04_detector.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part09_detector.py` | `outputs/verify_eca.json` | ECA 검증 · 그림은 각각 수 분 (GPU 1장) |
| [53](../reports/_parts/53_cfar-calib.ipynb) cfar-calib | `cd /workspace/sionna`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/verify_cfar.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/viz_report04_detector.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part09_detector.py` | `outputs/verify_cfar.json`<br>`outputs/prior_census.json` | CFAR 측정이 2717 s [^1] (GPU 1장) |
| [54](../reports/_parts/54_cfar-why.ipynb) cfar-why | `cd /workspace/sionna`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/verify_cfar.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/viz_report04_detector.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part09_detector.py` | `outputs/verify_cfar.json` | CFAR 측정이 2717 s [^7] (GPU 1장) |
| [55](../reports/_parts/55_observability.ipynb) observability | `cd /workspace/sionna`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/verify_observability.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/viz_report04_detector.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part09_detector.py` | `outputs/verify_observability.json` | 관측가능성 계산 · 그림은 각각 수 분 |

## 부 10 — 검출 결과

| 편 | 명령 | 출력 | 소요 |
|---|---|---|---|
| [56](../reports/_parts/56_geometry.ipynb) geometry | `cd /workspace/sionna`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/experiment_freespace_sigma.py`<br>`for D in mini5pro mavic4pro matrice4e phantom4 s1000plus; do \`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/experiment_freespace_range.py \`<br>`--stage all --mode W1,L1,G1 --drone $D; done`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part10_results.py` | `outputs/report13_freespace.json`<br>`outputs/verify_freespace.json`<br>`outputs/sbr_defect_fixes.json`<br>`outputs/phi_sweep.json` | σ 격자 · 검지거리 4단계 · 검증 · 스윕을 합쳐 7.8 h [^15] (GPU 2 [^16]장). 이 빌더 자신은 CPU 수 초다 |
| [57](../reports/_parts/57_sensitivity-chain.ipynb) sensitivity-chain | `cd /workspace/sionna`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/experiment_freespace_sigma.py`<br>`for D in mini5pro mavic4pro matrice4e phantom4 s1000plus; do \`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/experiment_freespace_range.py \`<br>`--stage all --mode W1,L1,G1 --drone $D; done`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part10_results.py` | `outputs/report13_freespace.json`<br>`outputs/verify_linkbudget.json`<br>`outputs/sigma_sensitivity.json`<br>`outputs/report05_derived.json` | σ 격자 · 검지거리 4단계 · 검증 · 스윕을 합쳐 7.8 h [^15] (GPU 2 [^16]장). 이 빌더 자신은 CPU 수 초다 |
| [58](../reports/_parts/58_shared-threshold.ipynb) shared-threshold | `cd /workspace/sionna`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/experiment_freespace_sigma.py`<br>`for D in mini5pro mavic4pro matrice4e phantom4 s1000plus; do \`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/experiment_freespace_range.py \`<br>`--stage all --mode W1,L1,G1 --drone $D; done`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part10_results.py` | `outputs/report13_freespace.json`<br>`outputs/report05_derived.json` | σ 격자 · 검지거리 4단계 · 검증 · 스윕을 합쳐 7.8 h [^13] (GPU 2 [^14]장). 이 빌더 자신은 CPU 수 초다 |
| [59](../reports/_parts/59_slope-anchor.ipynb) slope-anchor | `cd /workspace/sionna`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/sigma_anchor.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part10_results.py` | `outputs/sigma_anchor.json`<br>`outputs/lowfreq_attack.json`<br>`outputs/report05_derived.json` | σ 격자 · 검지거리 4단계 · 검증 · 스윕을 합쳐 7.8 h [^8] (GPU 2 [^9]장). 이 빌더 자신은 CPU 수 초다 |
| [60](../reports/_parts/60_r90.ipynb) r90 | `cd /workspace/sionna`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/experiment_freespace_sigma.py`<br>`for D in mini5pro mavic4pro matrice4e phantom4 s1000plus; do \`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/experiment_freespace_range.py \`<br>`--stage all --mode W1,L1,G1 --drone $D; done`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/sigma_anchor.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part10_results.py` | `outputs/report13_freespace.json`<br>`outputs/sigma_anchor.json`<br>`outputs/sigma_sensitivity.json`<br>`outputs/report05_derived.json` | σ 격자 · 검지거리 4단계 · 검증 · 스윕을 합쳐 7.8 h [^11] (GPU 2 [^12]장). 이 빌더 자신은 CPU 수 초다 |
| [61](../reports/_parts/61_rank-durability.ipynb) rank-durability | `cd /workspace/sionna`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/experiment_detection.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part10_results.py` | `outputs/sigma_sensitivity.json` | σ 격자 · 검지거리 4단계 · 검증 · 스윕을 합쳐 7.8 h [^15] (GPU 2 [^16]장). 이 빌더 자신은 CPU 수 초다 |
| [62](../reports/_parts/62_cpi-sweep.ipynb) cpi-sweep | `cd /workspace/sionna`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/sigma_sensitivity.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part10_results.py` | `outputs/cpi_guard_sweep.json` | σ 격자 · 검지거리 4단계 · 검증 · 스윕을 합쳐 7.8 h [^13] (GPU 2 [^14]장). 이 빌더 자신은 CPU 수 초다 |
| [63](../reports/_parts/63_cpi-residual.ipynb) cpi-residual | `cd /workspace/sionna`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/sigma_sensitivity.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part10_results.py` | `outputs/cpi_guard_sweep.json` | σ 격자 · 검지거리 4단계 · 검증 · 스윕을 합쳐 7.8 h [^11] (GPU 2 [^12]장). 이 빌더 자신은 CPU 수 초다 |
| [64](../reports/_parts/64_sigma-free-axis.ipynb) sigma-free-axis | `cd /workspace/sionna`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/experiment_detection.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part10_results.py` | `outputs/detection_rx_sweep.json`<br>`outputs/report05_derived.json` | σ 격자 · 검지거리 4단계 · 검증 · 스윕을 합쳐 7.8 h [^15] (GPU 2 [^16]장). 이 빌더 자신은 CPU 수 초다 |
| [65](../reports/_parts/65_target-model-swap.ipynb) target-model-swap | `cd /workspace/sionna`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part10_results.py` | `outputs/tm_result.json`<br>`outputs/tm_attack.json` | σ 격자 · 검지거리 4단계 · 검증 · 스윕을 합쳐 7.8 h [^15] (GPU 2 [^16]장). 이 빌더 자신은 CPU 수 초다 |
| [66](../reports/_parts/66_rx-elements.ipynb) rx-elements | `cd /workspace/sionna`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/experiment_detection.py`<br>`PYTHONPATH=src /workspace/.venvs/py312/bin/python src/build_part10_results.py` | `outputs/detection_rx_sweep.json`<br>`outputs/report05_derived.json` | σ 격자 · 검지거리 4단계 · 검증 · 스윕을 합쳐 7.8 h [^10] (GPU 2 [^11]장). 이 빌더 자신은 CPU 수 초다 |

## 부 11 — 실측 설계

| 편 | 명령 | 출력 | 소요 |
|---|---|---|---|
| [67](../reports/_parts/67_hardware.ipynb) hardware | `PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/plan_measurement.py`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python -c "import sigma_anchor as S; S.write_measurement_plan()"`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python src/make_report06_measurement.py` | `outputs/report06_measurement.json`<br>`outputs/measurement_plan.json`<br>`outputs/report06_derived.json` | 약 10 초 (CPU) |
| [68](../reports/_parts/68_sigma-checklist.ipynb) sigma-checklist | `PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/plan_measurement.py`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python -c "import sigma_anchor as S; S.write_measurement_plan()"`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python src/make_report06_measurement.py` | `outputs/report06_measurement.json`<br>`outputs/measurement_plan.json`<br>`outputs/report06_derived.json` | 약 10 초 (CPU) |
| [69](../reports/_parts/69_site-geometry.ipynb) site-geometry | `PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/plan_measurement.py`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python -c "import sigma_anchor as S; S.write_measurement_plan()"`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python src/make_report06_measurement.py` | `outputs/report06_measurement.json`<br>`outputs/measurement_plan.json`<br>`outputs/report06_derived.json` | 약 10 초 (CPU) |
| [70](../reports/_parts/70_calibration-sphere.ipynb) calibration-sphere | `PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/plan_measurement.py`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python -c "import sigma_anchor as S; S.write_measurement_plan()"`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python src/make_report06_measurement.py` | `outputs/report06_measurement.json`<br>`outputs/measurement_plan.json`<br>`outputs/report06_derived.json` | 약 10 초 (CPU) |
| [71](../reports/_parts/71_subband.ipynb) subband | `PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/plan_measurement.py`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python -c "import sigma_anchor as S; S.write_measurement_plan()"`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python src/make_report06_measurement.py` | `outputs/report06_measurement.json`<br>`outputs/measurement_plan.json`<br>`outputs/report06_derived.json` | 약 10 초 (CPU) |
| [72](../reports/_parts/72_attitude.ipynb) attitude | `PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/plan_measurement.py`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python -c "import sigma_anchor as S; S.write_measurement_plan()"`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python src/make_report06_measurement.py` | `outputs/report06_measurement.json`<br>`outputs/measurement_plan.json`<br>`outputs/report06_derived.json` | 약 10 초 (CPU) |
| [73](../reports/_parts/73_three-layers.ipynb) three-layers | `PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/plan_measurement.py`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python -c "import sigma_anchor as S; S.write_measurement_plan()"`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python src/make_report06_measurement.py` | `outputs/report06_measurement.json`<br>`outputs/measurement_plan.json`<br>`outputs/report06_derived.json` | 약 10 초 (CPU) |
| [74](../reports/_parts/74_sim-vs-meas.ipynb) sim-vs-meas | `PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/plan_measurement.py`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python -c "import sigma_anchor as S; S.write_measurement_plan()"`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python src/make_report06_measurement.py` | `outputs/report06_measurement.json`<br>`outputs/measurement_plan.json`<br>`outputs/report06_derived.json` | 약 10 초 (CPU) |
| [75](../reports/_parts/75_decision-matrix.ipynb) decision-matrix | `PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/plan_measurement.py`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python -c "import sigma_anchor as S; S.write_measurement_plan()"`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python src/make_report06_measurement.py` | `outputs/report06_measurement.json`<br>`outputs/measurement_plan.json`<br>`outputs/report06_derived.json` | 약 10 초 (CPU) |
| [76](../reports/_parts/76_session-drift.ipynb) session-drift | `PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/plan_measurement.py`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python -c "import sigma_anchor as S; S.write_measurement_plan()"`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python src/make_report06_measurement.py` | `outputs/report06_measurement.json`<br>`outputs/measurement_plan.json`<br>`outputs/report06_derived.json` | 약 10 초 (CPU) |
| [77](../reports/_parts/77_size-law-differential.ipynb) size-law-differential | `PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python benchmark/plan_measurement.py`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python -c "import sigma_anchor as S; S.write_measurement_plan()"`<br>`PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python src/make_report06_measurement.py` | `outputs/report06_measurement.json`<br>`outputs/measurement_plan.json`<br>`outputs/report06_derived.json` | 약 10 초 (CPU) |
