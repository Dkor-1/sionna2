...
cells = [
    ...
    md("## 절 4. 플래시 — 주기는 로터가, 시각은 방위가 정한다", "",
       ...
       "⚠ 그 대비는 **두 팔에 걸쳐** 있다 — 플래시 관측량은 SBR 팔이, 맞대는 도플러 축척은 "
       "순수 PO 대조팔이 낸다. 아래 표의 열 제목에 팔을 박았고, 조건 차이는 표 밑에 적었다.", "",
       ...
       "⭐ **주장의 크기.** 이 대비는 순수 PO 팔의 도플러와 SBR 팔의 플래시를 맞댄 것이므로, "
       "여기서 세우는 것은 «두 관측량이 기하에 따라 따로 움직인다» 까지다. 한 커널 안에서 같은 "
       "갈림이 서는지는 위 ⚠ 가 적은 대로 이 원장 밖이다.", "",
