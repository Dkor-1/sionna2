...
cells.append(md(
    ...
    "",
    "**왜 광선추적(Sionna RT)이 아니라 PO?** — 검증해 봤더니 **RT 에는 표적의 σ 를 담는 자리가 아예 없습니다.**",
    "Sionna RT 의 path solver 가 표적에서 만드는 경로는 두 종류뿐인데 둘 다 σ 의 함수가 아닙니다:",
    "",
    "| RT 경로 | 진폭 법칙 | 실측 |",
    "|---|---|---|",
    ...
    "편의가 아니라 필연입니다. (근거·재현: `benchmark/verify_rt_no_rcs.py` · `docs/VERIFY_RT_VS_PO.md`)",
    "",
