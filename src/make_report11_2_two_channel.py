# -*- coding: utf-8 -*-
"""
make_report11_2_two_channel.py — 리포트 11-2 「기준채널이 현실이면 얼마를 잃는가」를 짓는다.

11 권(`reports/11_detector.ipynb`)이 ECA·CFAR 사슬을 세웠다. 다만 그 권과 헤드라인 검출
수치는 기준신호를 **송신 파형 그 자체**(잡음 0 · 다중경로 0)로 준다 — 즉 «기준안테나가
완벽하다» 는 상한이다. 이 편은 그 가정 하나를 푼다.
8 권 5 편(`reports/08_5_bistatic.ipynb`)이 «이 편은 기하만 본다, 2채널 처리는 쓰지 않는다» 고
그은 경계의 반대편이 여기다.
...
OUT = os.path.join(_ROOT, "reports", "11_2_two_channel.ipynb")
...
cells = [
    md("# 리포트 11-2 — 기준채널이 현실이면 **얼마를 잃는가**", "",
       ...
       "섞인다. 그런데 11 권의 사슬과 우리 헤드라인 검출 수치는 기준신호로 **송신 파형 "
       ...
       "13 권이 말하고, 여기서 말하는 것은 **이상적 기준 대비 손실**뿐이다.", "",
    ...
    md("## 절 0. 무엇을 묻나 · 무엇을 안 묻나", "",
       ...
       "| 어디 | 무엇을 했나 | 이 편과의 관계 |",
       "|---|---|---|",
       "| [8 권 5 편 «마이크로도플러 — 바이스태틱»](08_5_bistatic.ipynb) | 표적이 바이스태틱 "
       "기하에서 무엇을 되돌려주는가 | 그 편은 «2채널 처리(ECA·CAF)는 쓰지 않는다» 고 경계를 "
       "긋고, 그 다음 질문을 이 편에 넘겼다 |",
       "| [11 권 «처리 사슬»](11_detector.ipynb) | ECA·거리도플러·CFAR 를 세우고 경험 Pfa 를 "
       "교정했다 | 그 사슬을 **한 줄도 안 고치고** 그대로 쓴다. 다른 것은 기준신호 하나뿐 |",
       "| **이 편 (11-2)** | 기준채널이 현실이면 그 사슬이 얼마를 잃는가 | — |",
       "| [13 권 «결과»](13_results.ipynb) | R90 과 파형 순위 | 그 수치는 «이상적 기준» 위에 "
       "서 있다. 이 편의 손실이 그 위에 얹힌다 |",
       "| [15 권 «실측 계획»](15_measurement.ipynb) | 야외 캠페인 규약 | 절 3 의 "
    ...
    md("### ⭐ 갈아끼워도 사슬이 안 변했다 — 항등식 검사", "",
       ...
       "즉 이 편에서 달라지는 것은 **기준신호 하나**이고, 사슬도 표적 주입 경로도 11 권의 "
       "그것과 같은 물건이다."),
    ...
    md("## 절 5. Pd 가 0 인 칸에서 빗살은 어디까지 남나 — 그리고 5G 는 접힌다", "",
       ...
       "[8 권 5 편](08_5_bistatic.ipynb)이 보인 대로 바이스태틱이 되면 도플러축이 이등분선의 "
    ...
    md("## 절 7. 이 편이 서 있는 자리", "",
       ...
       "경험 Pfa 가 달라 팔 간 Pd 비교가 반쪽이다(11 권 절 3 의 절차를 그대로 쓰면 된다) |",
       "| ③ | 깨끗한 **바이스태틱 마이크로도플러 원장**을 만든다 | 절 5 의 모노스태틱 재사용 "
       "근사를 없앤다. 광선 팔의 광대역 슬로타임 바닥이 먼저 풀려야 한다(8 권 5 편 절 2) |",
       ...
       "",
       "**15 권으로 넘기는 것 하나** — 이 편이 준 기준안테나 이득 요구치는 퇴화된 기준점 대비 "
