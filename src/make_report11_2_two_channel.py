...
cells = [
    ...
    md("## 부록 — 재현", "",
       ...
       f"PYTHONPATH=src:benchmark /workspace/.venvs/py312/bin/python \\",
       f"    {META['script']} --stage all",
       "",
       "# ② 그림 셋",
       "PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/build_passive_figs.py",
       "PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/build_passive_figs2.py",
       "PYTHONPATH=src /workspace/.venvs/py312/bin/python benchmark/build_passive_figs3.py",
       "",
       "# ③ 이 노트북",
       "PYTHONPATH=src /workspace/.venvs/py312/bin/python src/make_report11_2_two_channel.py",
       "```", "",
       "**딸린 파일**", "",
       "| 무엇 | 어디 |",
       "|---|---|",
