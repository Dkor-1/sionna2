        ...
        ⭐실측(matrice4e · 3.5 GHz · 15 m · **생산 간격 λ/12** · 앙각 넷 ×
          ...
          → outputs/ground_reciprocity_0907.json):
            ...
            · 그 차가 «합친 장» 에 걸리는 몫 — 중앙값 **0.1799 dB**,
              ...
              2/32 · 최대 1.3659 dB
        ⭐**이것은 이산화 오차다 — 격자를 촘촘히 하면 준다.** 같은 드론 메쉬에서
          상대차 중앙값이 lam/8 0.3549 · lam/12 0.1442 · lam/16 0.0865 · lam/24 0.0576 로 간다. 곧 「커널이 구조적으로 비상호적이라 못 고친다」가
          아니라 「λ/12 격자가 그만큼 성기다」는 뜻이다.
