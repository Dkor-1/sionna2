...
def fig_sbr(d, outdir=FIG):
    ...
    _caption(fig,
        ...
        f"and |DC|/std(AC) drops by {md['gain_db']:.1f} dB — the blade modulation is that much deeper than the PO estimate said "
        "(what that buys a detector, once threshold, Pfa and integration time are fixed, is not measured here). "
