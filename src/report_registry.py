...
#  문서가 아니다** — 사람이 읽는 것은 `reports/` 의 본편 권과 별편이다(`src/build_volumes.py`).
#  ⛔2026-09-17 — the counts written here («본편 11 권 + 별편 8 편, 곧 노트북 23 개») were stale
#  (docs/NEW_FILE_RULES.md §1 cites this line). Counts are not typed in comments; they are
#  `outputs/volumes_index.json : _meta.n_volumes · n_companions · n_notebooks`.
