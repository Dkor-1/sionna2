...
처음이면 [리포트 1 «이 연구가 묻는 것과 답한 방식»](01_map.ipynb) 부터다 — 열다섯 권의 지도와 읽는 경로 셋이 거기 있다.
...
| 절 | 제목 | 조각 |
|---|---|---|
| 1 | 열다섯 권의 지도 — 무엇이 어디에 있나 | (이 스크립트가 생성) |
...
| 3 | 그 순위는 자세평균이면 σ 오차 아래에서 하나로 모인다 | `_parts/61_rank-durability.ipynb` |
...
| 절 | 제목 | 조각 |
|---|---|---|
| 1 | 앙각 7 점을 10 m 한 자리에서 재고, 28 행 중 26 행만 판정에 쓴다 | `_parts/78_el-sweep-design.ipynb` |
...
| 4 | 우리 커널은 덱 3~40 m 판과 0.9141~0.9877 로 겹치고, 엔진이 바뀐 한 칸은 0.6961 이다 | `_parts/86_physics-deck-match.ipynb` |
